...
import { selectUser } from "@/store/slice/auth/index"; // Ensure the path is correct
        ...
        <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
                ...
                <FormDescription>Your public-facing alias. Use your username to send and receive tests.</FormDescription>
                <FormControl>
                    <Input {...field} />
                </FormControl>
                <FormMessage />
...
<Dialog>
            ...
            <DialogContent>
              ...
              <form onSubmit={(e) => {
                ...
                <Input type="password" name="currentPassword" placeholder="Current Password" required className="mb-2" />
                <Input type="password" name="newPassword" placeholder="New Password" required className="mb-2" />
                <Input type="password" name="confirmPassword" placeholder="Confirm New Password" required className="mb-6" />
