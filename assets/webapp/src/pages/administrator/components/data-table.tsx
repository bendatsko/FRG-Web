    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description:
            "Your invite has been processed and an invitation has been sent to the new user via email.",
          variant: "",
        });
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px] dark:bg-[#09090b]">
            <DialogHeader>
              ...
              <DialogDescription>
                Complete the following fields to create an account on behalf of
                a new user.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  className="col-span-3 dark:placeholder-white/50 border dark:border-white/75"
                />
        ...
        <Dialog open={isResetDialogOpen} onOpenChange={setIsResetDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px] dark:bg-[#09090b]">
            <DialogHeader>
              ...
              <DialogDescription>
                Enter the user's email address to reset their password. A new
                temporary password will be generated and sent to the user's
                email.
              </DialogDescription>
            </DialogHeader>
