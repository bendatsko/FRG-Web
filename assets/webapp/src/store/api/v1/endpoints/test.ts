...
const testApi = api.injectEndpoints({
    endpoints: (builder) => ({
        getTests: builder.query({
            query: (userId) => ({
                url: `http://10.1.10.248:3001/tests?username=${userId}`,
                method: "GET",
            }),
            providesTags: ["Test"],
        }),
        getTestById: builder.query({
            query: (id) => ({
                url: `http://10.1.10.248:3001/tests/${id}`,
                method: "GET",
            }),
        ...
        updateThreshold: builder.mutation({
            query: ({id, threshold}) => ({
                url: `http://10.1.10.248:3001/tests/${id}/threshold`,
                method: "PUT",
                body: {threshold},
            }),
        ...
        rerunTest: builder.mutation({
            query: (id) => ({
                url: `http://10.1.10.248:3001/tests/${id}/rerun`,
                method: "POST",
            }),
            invalidatesTags: (result, error, id) => [{type: "Test", id}],
        }),
        downloadResults: builder.query({
            query: (id) => ({
                url: `http://10.1.10.248:3001/tests/${id}/download`,
                method: "GET",
